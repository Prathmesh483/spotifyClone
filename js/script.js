...
const play = document.querySelector(".play"); // Ensure play is selected
const next = document.querySelector(".next"); // Ensure next is selected
const previous = document.querySelector(".previous"); // Ensure previous is selected
...
const displayAlbumName = (albumName) => {
  document.querySelector(".albumName").innerHTML = `
    <svg class="invert" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" color="#000000" fill="none">
